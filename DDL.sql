...
CREATE TABLE IF NOT EXISTS clientes (
    ...
    loja_mais_frequente VARCHAR(18),  -- CNPJ da loja onde o cliente mais fez compras
    loja_ultima_compra VARCHAR(18)    -- CNPJ da loja onde o cliente fez a última compra
);